...
const ConventionSummerPicnic2022 = () => {
  const posterImage = '/lovable-uploads/66bb0ed6-0f5b-4f17-bd81-669ba8fab887.png';
...
export default ConventionSummerPicnic2022;