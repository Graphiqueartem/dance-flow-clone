...
const SadlersWellsFeb = () => {
  const posterImage = '/lovable-uploads/0dd3104d-96f6-481e-893a-3d8851d15782.png';
      ...
      <div className="bg-primary text-primary-foreground py-12 sm:py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-poppins font-bold mb-4">
            Sadlers Wells Competition 2023
          </h1>
            ...
            <Card className="bg-white border-0 shadow-lg">
              <CardContent className="p-8 sm:p-12">
                ...
                <div className="relative mb-8 max-w-md mx-auto">
                  <img 
                    src={posterImage} 
                    alt="Sadlers Wells 2023 - Sold Out"
...
export default SadlersWellsFeb;